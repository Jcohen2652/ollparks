-- OLL PARKS — données de démo
-- Charger après schema.sql : psql ... -f db/schema.sql -f db/seed.sql

-- ============================================================
-- ENTREPRISES
-- ============================================================
INSERT INTO entreprises (id, siren, raison_sociale, secteur, effectif, ca, score) VALUES
...
-- CONTACTS
-- ============================================================
INSERT INTO contacts (id, entreprise_id, prenom, nom, email, poste, role_immo, score, source) VALUES
...
-- BIENS
-- ============================================================
INSERT INTO biens (id, reference, typologie, statut, transaction, surface_m2, prix, loyer_annuel, adresse, ville, code_postal, geom, off_market, mandat_interne) VALUES
...
-- BESOINS
-- ============================================================
INSERT INTO besoins (id, entreprise_id, contact_id, typologie, transaction, surface_min, surface_max, budget_min, budget_max, zones, timing, statut) VALUES
  ('ccccccc1-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', 'aaaaaaa3-3333-3333-3333-333333333333',
    'bureaux', 'location', 600, 1200, 400000, 800000, ARRAY['paris', '92'], 'immediat', 'actif'),

  ('ccccccc2-2222-2222-2222-222222222222', '55555555-5555-5555-5555-555555555555', 'aaaaaaa5-5555-5555-5555-555555555555',
    'bureaux', 'location', 200, 500, 100000, 250000, ARRAY['paris'], '3 mois', 'actif'),

  ('ccccccc3-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444', 'aaaaaaa4-4444-4444-4444-444444444444',
    'entrepot', 'location', 4000, 8000, 500000, 1000000, ARRAY['93', '95'], '6 mois', 'actif');

-- ============================================================
-- INTERACTIONS (échantillon)
-- ============================================================
INSERT INTO interactions (type, direction, contact_id, entreprise_id, sujet, occurred_at) VALUES
